...
<p align="center">
  ...
  <a href="#tools"><img src="https://img.shields.io/badge/MCP-6%20tools-6C47FF" alt="MCP tools" /></a>
</p>
...
| `send_code` | Execute C# against AutoCAD .NET API (escape hatch, 30s timeout) |
...
`send_code` executes arbitrary C# with full access to the AutoCAD process and local filesystem. The security model relies on:
...
├── lib/acad24/            # Reference assemblies for CI
└── .github/workflows/     # CI
```
